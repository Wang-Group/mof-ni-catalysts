...
The MOF descriptors for the synthesized MOFs were calculated acccording to the methods described in the [ARC-MOF paper](https://pubs.acs.org/doi/abs/10.1021/acs.chemmater.2c02485). Please refer to [this repo]() for the details to calculate the descriptors.
